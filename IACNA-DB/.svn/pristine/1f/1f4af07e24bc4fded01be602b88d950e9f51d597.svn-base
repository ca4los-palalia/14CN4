...
public class Turno implements Serializable {
	...
	public static String PRIMER_TURNO = "Primer Turno";
	public static String SEGUNDO_TURNO = "Segundo Turno";
	public static String TERCER_TURNO = "Tercer Turno";
	public static int PRIMER_TURNO_ORDINAL = 0;
	public static int SEGUNDO_TURNO_ORDINAL = 1;
	public static int TERCER_TURNO_ORDINAL = 2;
